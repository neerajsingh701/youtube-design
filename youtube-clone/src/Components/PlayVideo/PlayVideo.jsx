...
const PlayVideo = () => {
    ...
    const fetchOtherData = async () => {
        ...
        // fetching chennal data
        const channelData_url = `https://youtube.googleapis.com/youtube/v3/channels?part=snippet%2CcontentDetails%2Cstatistics&id=${apiData.snippet.channelId}&key=${API_KEY}`
        await fetch(channelData_url).then(response => response.json()).then(data => setChennalData(data.items[0]))
    ...
    return (
        <div className='play-video'>
            ...
            <div className="play-video-info">
                <p>{apiData ? value_converter(apiData.statistics.viewCount) : "20k"} views &bull; {apiData?moment(apiData.snippet.publishedAt).fromNow():""} </p>
                <div>
            ...
            <div className="publisher">
                <img src={channelData ? channelData.snippet.thumbnails.default.url : "1M"} alt="" />
                <div>
            ...
            <div className="vid-description">
                ...
                <hr />
                <h4>{apiData ? value_converter(apiData.statistics.commentCount) : 160} Comments</h4>
